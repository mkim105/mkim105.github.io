...
## Section 2-18. Obsolete(쓸모없는) Members를 지우는 방법

Delete Method를 이용하면 된다.
여기서 Element를 이용하는 것 보다는 ElementId를 이용하여 삭제하는 것이 나은데, 왜냐하면 ElementId가 훨씬 smaller, lighter 하기 때문이다.
